...
<Aside type="tip">
Want to try a range before installing? The [Sequence Generator](/tools/sequence-generator/)
runs the same convnum conversions in your browser.
</Aside>

## What `start` can be

Anything [convnum](/) recognises: 26 numeral systems plus dates, each counted and written
