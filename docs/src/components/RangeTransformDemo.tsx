...
type ScenarioId = keyof (typeof toolText)['en']['rtScenarios']
...
export default function RangeTransformDemo({ locale = 'en' }: { locale?: ToolLocale }) {
  ...
  }, [running, phase, typed, index, chars.length])
  ...
  return (
    <figure
      className="rt-demo not-content"
      aria-label={t.rtDemoLabel}
