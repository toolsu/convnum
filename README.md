<p align="center"><a href="https://toolsu.com/convnum/"><img width="512" src="./docs/public/images/logo/logo.svg" alt="ConvNum logo" /></a></p>
...
Detailed documentation is available at [toolsu.com/convnum](https://toolsu.com/convnum/).

## Supported Types

The library supports validation, detection, and formatting of the following number representation types:

([`NumType`](https://toolsu.com/convnum/api/type-aliases/numtype/) is a type used in this library to identify different number representations)

| Name                                                                            | [NumType](https://toolsu.com/convnum/api/type-aliases/numtype/) | Examples                                  | Notes                                                                                                                                                                                                  |
| ------------------------------------------------------------------------------- | ------------------------------------------------------------ | ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Decimal                                                                         | `decimal` (alias: `dec`)                                     | "123", "456"                              | Standard base-10 numbers                                                                                                                                                                               |
| [Latin letters](https://toolsu.com/convnum/api/readme/#alphabet)                       | `latin_letter`                                               | "A", "b", "Z"                             | Standard Latin alphabet                                                                                                                                                                                |
| [Month](https://toolsu.com/convnum/api/readme/#date)                                   | `month_name`                                                 | "January", "JAN", "février", "1月"        | Month names in any language, via [`Intl`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl). Detection is English-only by default; pass `getTypes(str, { locales })` to recognise other languages — see [Languages](#languages)                     |
| [Day of week](https://toolsu.com/convnum/api/readme/#date)                             | `day_of_week`                                                | "Monday", "MON", "lundi", "星期一"         | Day names in any language, via [`Intl`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl). Detection is English-only by default; pass `getTypes(str, { locales })` to recognise other languages — see [Languages](#languages)                       |
| [Roman numerals](https://toolsu.com/convnum/api/readme/#roman-numeral)                 | `roman`                                                      | "VI", "vi", "MMMCMXCIX"                   | Roman numeral system (range: 1-3999). Does not support single Unicode character form like "Ⅵ"                                                                                                          |
| [Arabic numerals](https://toolsu.com/convnum/api/readme/#eastern-arabic-numeral)       | `arabic`                                                     | "٠", "١", "٢"                             | Eastern Arabic numerals                                                                                                                                                                                |
| [English words](https://toolsu.com/convnum/api/readme/#english-numeral)                | `english_words`                                              | "one hundred twenty-three", "thReE"       | Written English numbers                                                                                                                                                                                |
| [English ordinal words](https://toolsu.com/convnum/api/readme/#english-numeral)        | `english_ordinal_words`                                      | "first", "twenty-first", "ThIrD"          | Written English ordinal numbers                                                                                                                                                                        |
| [English ordinal abbreviation](https://toolsu.com/convnum/api/readme/#english-numeral) | `english_ordinal_abbr`                                       | "1st", "2Nd", "3RD"                       | English ordinal numbers with suffixes                                                                                                                                                                  |
| [French words](https://toolsu.com/convnum/api/readme/#french-numeral)                  | `french_words`                                               | "cent-vingt-trois", "TroIs"               | Written French numbers. Output uses the fully hyphenated 1990-reform form ("cent-vingt-trois"); input accepts both the reform and traditional ("cent vingt-trois") forms, with strictly official spelling (e.g. "quatre-vingt-mille", "deux-cent-mille") |
| [French ordinal words](https://toolsu.com/convnum/api/readme/#french-numeral)          | `french_ordinal_words`                                       | "premier", "vingt-et-unième", "TrOiSièMe" | Written French ordinal numbers ("mille-unième", not "mille-premier")                                                                                                                                   |
| [French ordinal abbreviation](https://toolsu.com/convnum/api/readme/#french-numeral)   | `french_ordinal_abbr`                                        | "1er", "1re", "2e", "3e"                  | French ordinal numbers with suffixes: "1er" (premier), "1re" (première), and "Ne" for every other number                                                                                              |
| [Chinese words](https://toolsu.com/convnum/api/readme/#chinese-numeral)                | `chinese_words`                                              | "一万三千零二", "一萬三千零二"            | Standard Chinese numerals (simplified and traditional Chinese)                                                                                                                                         |
| [Chinese financial](https://toolsu.com/convnum/api/readme/#chinese-numeral)            | `chinese_financial`                                          | "壹万叁仟零贰", "壹萬叄仟零貳"            | Traditional financial characters (simplified and traditional Chinese)                                                                                                                                  |
| [Binary](https://toolsu.com/convnum/api/readme/#bases)                                 | `binary` (alias: `bin`)                                      | "1010", "0B1101"                          | Base-2 numbers (0-1 only)                                                                                                                                                                              |
| [Octal](https://toolsu.com/convnum/api/readme/#bases)                                  | `octal` (alias: `oct`)                                       | "123", "0o456"                            | Base-8 numbers (0-7 only)                                                                                                                                                                              |
| [Hexadecimal](https://toolsu.com/convnum/api/readme/#bases)                            | `hexadecimal` (alias: `hex`)                                 | "1A", "abc", "0xFF"                       | Base-16 numbers (0-9, A-F)                                                                                                                                                                             |
| [Greek letters](https://toolsu.com/convnum/api/readme/#alphabet)                       | `greek_letter`                                               | "Α", "α", "Ω"                             | Greek alphabet                                                                                                                                                                                         |
| [Greek letter names](https://toolsu.com/convnum/api/readme/#alphabet)                  | `greek_letter_english_name`                                  | "Alpha", "BETA", "gamma"                  | English names of Greek letters (Alpha, Beta, Gamma, etc.)                                                                                                                                              |
| [Cyrillic letters](https://toolsu.com/convnum/api/readme/#alphabet)                    | `cyrillic_letter`                                            | "А", "а", "Я"                             | Cyrillic alphabet                                                                                                                                                                                      |
| [Hebrew letters](https://toolsu.com/convnum/api/readme/#alphabet)                      | `hebrew_letter`                                              | "א", "ב", "ת"                             | Hebrew alphabet (22 standard letters, no upper/lower case distinction; no Final Forms)                                                                                                                 |
| [Chinese Heavenly Stems](https://toolsu.com/convnum/api/readme/#chinese-numeral)       | `chinese_heavenly_stem`                                      | "甲", "乙", "丙"                          | 天干 (Tiān Gān) (always same character in simplified and traditional Chinese)                                                                                                                          |
| [Chinese Earthly Branches](https://toolsu.com/convnum/api/readme/#chinese-numeral)     | `chinese_earthly_branch`                                     | "子", "丑", "寅"                          | 地支 (Dì Zhī) (always same character in simplified and traditional Chinese)                                                                                                                            |
| [Chinese Solar Terms](https://toolsu.com/convnum/api/readme/#chinese-numeral)          | `chinese_solar_term`                                         | "立春", "惊蛰", "驚蟄"                    | 节气 (Jié Qì) (simplified and traditional Chinese)                                                                                                                                                     |
| [Astrological signs](https://toolsu.com/convnum/api/readme/#astrological-sign)         | `astrological_sign`                                          | "Aries", "tauRuS"                         | Zodiac signs                                                                                                                                                                                           |
| [NATO phonetic](https://toolsu.com/convnum/api/readme/#alphabet)                       | `nato_phonetic`                                              | "Alfa", "alpha", "braVo", "Charlie"       | NATO phonetic alphabet                                                                                                                                                                                 |
